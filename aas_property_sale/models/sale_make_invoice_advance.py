...
class SaleAdvancePaymentInv(models.TransientModel):
    _name = "sale.prop.advance.payment.inv"
    ...
    deposit_account_id = fields.Many2one("account.account", string="Deposit Account", domain=[('deprecated', '=', False),('user_type_id.name', '=', 'Cursale Liabilities')],
    ...
    def create_deposits(self):
        sale_orders = self.env['property.sale'].browse(self._context.get('active_ids', []))
